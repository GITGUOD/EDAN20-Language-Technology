...
def words(text): return re.findall(r'\w+', text.lower()) # Använder regex biblioteket, importerar alla bokstäver
...
def correction(word): 
    ...
    return max(candidates(word), key=P) # Använder max funktionaliteten för att beräkna med sannolika kandidaten för ordet som ska rättas till med hjälp av P funktionen ovanför som beräknar sannolikheten och den andra parametern tar emot en hel lista av ord
